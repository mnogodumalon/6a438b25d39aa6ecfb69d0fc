// Auto-generated. Per-entity form-enhancements config for "Terminverwaltung".
...
export const formEnhancements: FormEnhancements = {
  ...
  defaults: {
    'termin_datum': { kind: 'today', withTime: true },
    'auftragsart': { kind: 'lookup', key: 'wartung', label: 'Wartung' },
