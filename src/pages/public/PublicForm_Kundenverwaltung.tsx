...
const PROXY_BASE = '';
const APP_ID = '6a438b0adf0702ab92fe4ca1';
...
export default function PublicFormKundenverwaltung() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Kundenverwaltung — Formular</h1>
        </div>
